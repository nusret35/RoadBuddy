        ...
        // Create cleaned versions of data
            ...
            Auth.auth().createUser(withEmail: email, password: password) { (result, err) in
                ...
                if err != nil {
                    ...
                    db.collection("users").document(String(uid)).setData( ["firstname":firstName,"lastname":lastName,"username":userName,"uid":result!.user.uid,"email":email,"password":password,"phoneNumber":phoneNumber,"schoolName":schoolName, "TripIsSet":false,"TaxiTripIsSet":false]) { (error) in
